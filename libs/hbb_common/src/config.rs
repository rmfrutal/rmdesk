...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RMDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rminf.com.br"];
pub const RS_PUB_KEY: &str = "yTn7VAxDbeRYKGHlkkY40srE+gZ7Zrx+gieDEoft3MM=";
